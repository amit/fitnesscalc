// This is the *viewmodel* - JavaScript that defines the data and behavior of your UI
...
function AppViewModel() {
    ...
    self.weight = ko.observable(175,{persist: 'weight'});
    self.height = ko.observable(175,{persist: 'height'});
  ...
  self.avg_hr_percent=ko.computed(function() { 
    ...
    self.rhr_vo2max = ko.computed(function() {
      var h=Number(self.resting_hr());
      return (Math.round(15.3*(self.maxhrtanaka() /(h*3))));
    },this);
    self.run_vo2max = ko.computed(function() {
      var m = Number(self.runtime_min());
      var s = Number(self.runtime_sec());
      return Math.round(483/(m+s/60) + 3.5);
    },this);
